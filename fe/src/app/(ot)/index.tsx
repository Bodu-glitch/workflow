        ...
        <View className="px-5 gap-4 pb-24">
          ...
          <View className="bg-surface-container-lowest rounded-2xl p-4">
            <View className="flex-row items-center justify-between mb-3">
              ...
              <Pressable onPress={() => router.push({ pathname: '/(ot)/tasks', params: { status: 'overdue' } })} className="active:opacity-60">
            ...
            {recentTasks.length === 0 ? (
              ...
              recentTasks.map((task) => {
                ...
                const overdueBy = h < 24 ? `${h}h overdue` : `${Math.floor(h / 24)}d overdue`;
                return (
                  <Pressable
                    key={task.id}
                  ...
                  >
                    <View className="w-8 h-8 rounded-xl items-center justify-center" style={{ backgroundColor: '#fff1f2' }}>
