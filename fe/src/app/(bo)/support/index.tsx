/**
 * BO — Support Ticket List
 * Shows open/in_progress tickets from staff members
 */
...
function TicketCard({ ticket }: { ticket: SupportTicket }) {
  ...
  return (
    <Pressable
      onPress={() => router.push({ pathname: '/(bo)/support/[id]', params: { id: ticket.id } })}
...
export default function BOSupportScreen() {
